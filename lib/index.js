...
module.exports = JSDocRunner = (function() {
  ...
  var compileDocs = function(){
    ...
    var result;
    result = execSync("node_modules/jsdoc-brunch/node_modules/.bin/jsdoc -t node_modules/jsdoc-brunch/jsdoc-templates/brunch " + INPUT + RECURSIVE + " -d " + DESTINATION, true);
